...
const LANG = {
  ...
  tr: {
    activateTitle: "Lisansinizi Aktive Edin",
    monthlyName: "AYLIK",
    monthlyPrice: "$10",
    monthlyPeriod: "/ay",
    monthlyFeature: "Sinirsiz fatura",
    freeTrialName: "UYE DENEME",
    freeTrialPrice: "$0",
    freeTrialFeature: "10 fatura ucretsiz",
    subscribeBtn: "Ucretsiz Basla",
    licenseKeyLabel: "Lisans Anahtari",
    licenseKeyPlaceholder: "Lisans anahtarini buraya yapistirin",
    activateBtn: "AKTIVE ET",
    validatingBtn: "KONTROL EDILIYOR...",
    monthlyPlan: "Aylik Plan",
    freeTrialPlan: "Ucretsiz Deneme",
    unlimited: "Sinirsiz",
    dateRangeLabel: "Tarih Araligi",
    fromDate: "Baslangic",
    toDate: "Bitis",
    analyzeBtn: "ANALIZ ET",
    analyzingBtn: "ANALIZ EDILIYOR...",
    ordersFound: "Siparisler Bulundu",
    cancelBtn: "IPTAL",
    downloadAllBtn: "HEPSINI INDIR",
    downloading: "Indiriliyor...",
    stopBtn: "DUR",
    downloadComplete: "Indirme Tamamlandi",
    newDownloadBtn: "YENI INDIRME",
    ok: "OKU",
    fail: "HATA",
    total: "Toplam",
    current: "Su an",
    remaining: "kaldi",
    invalidKey: "Gecersiz lisans anahtari. Kontrol edin ve tekrar deneyin.",
    validationFailed: "Dogrulama basarisiz oldu. Tekrar deneyin.",
    enterKey: "Lisans anahtarini girin",
    noOrders: "Her iki tarihi de secin",
    dateOrder: "Baslangic tarihi, bitis tarihinden once olmali",
    licenseRevoked: "Lisans iptal edildi (iade/dispute). Lutfen destek ile iletisime gecin.",
    networkError: "Lisans online dogrulanamadi. Baglantinizi kontrol edin.",
    rateLimit: "Cok fazla deneme. Lutfen bekleyip tekrar deneyin.",
    noOrdersFound: "Siparis bulunamadi. AliExpress dilinin Ingilizce oldugundan emin olun (sag ust kosede).",
    errNetwork: "Lisans sunucusuna baglanamadi. Internet baglantinizi kontrol edin.",
    errInvalid: "Gecersiz lisans anahtari. Kontrol edin ve tekrar deneyin.",
    errRefunded: "Bu satin alma iade edilmis. Lisans iptal edildi.",
    errDisputed: "Bu satin alma dispute altinda. Lisans iptal edildi.",
    errRateLimit: "Cok fazla deneme. Lutfen bekleyip tekrar deneyin.",
  }
};
